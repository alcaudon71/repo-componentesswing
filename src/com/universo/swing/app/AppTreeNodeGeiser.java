...
import com.universo.swing.util.RenderTree;

public class AppTreeNodeGeiser {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		MarcoTreeGeiser miMarco = new MarcoTreeGeiser();
...
// Frame
class MarcoTreeGeiser extends JFrame {
	...
	public MarcoTreeGeiser() {
		...
		// Establecemos el Render para el Arbol
		RenderTree miRenderArbol = new RenderTree();
		vistaArbol.setCellRenderer(miRenderArbol);
		
		// Establecemos Listener para seleccion de Nodo
		vistaArbol.addTreeSelectionListener(new TreeSelectionListener() {
			public void valueChanged(TreeSelectionEvent e) {
				Integer cantSelecc = vistaArbol.getSelectionCount();
				TreePath pathNodo = vistaArbol.getSelectionPath();
				Object componenteNodo = pathNodo.getLastPathComponent();
				DefaultMutableTreeNode nodo = (DefaultMutableTreeNode) componenteNodo;
				Object objetoNodo = nodo.getUserObject();
				System.out.println("Nodo Valor cambiado: " + objetoNodo.toString());
			}
		});
